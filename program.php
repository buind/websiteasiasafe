            ...
            <div class="content">
                <div class="p-3 content-right">
                    ...
                    <div class="content-des">
                        <p>
                            The Master's Program in Traffic Safety Engineering
                            aims to train high-quality human resources equipped
                            with extensive, solid and modern knowledge in the
                            field of traffic safety. Graduates from this program
                            will be able to design, operate and manage
                            transportation systems safely and efficiently;
                            capable of handling traffic jams and accidents; have
                            skills in assessing, analyzing and providing
                            solutions to overcome the causes of traffic
                            accidents; have self-study and research skills to
                            adapt to the working environment and the development
                            of science and technology in the trend of
                            international integration.
                        </p>
                        <p>
                            After graduation, the Master of Traffic Safety
                            Engineering can work in:
                        </p>
                        <ul style="list-style: circle;font-size: 16px; color:#6b6d7b">
                            <li>Units under the Ministry of Transport.</li>
                            <li>
                                State management agencies on traffic order and
                                safety.
                            </li>
                            <li>
                                Construction consulting companies for traffic
                                works.
                            </li>
                            <li>
                                Agents, transport enterprises and auto insurance.
                            </li>
                            <li>
                                Universities and colleges, domestic and foreign
                                scientific research institutes and centers.
                            </li>
                        </ul>
                    </div>
                </div>

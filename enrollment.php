...
<div class="container">
    <div id="main">
        <div class="main-content">
            ...
            <div class="p-3 scholarships" style="background-color: #ccc;">
                <div class="pdf_option">
                    <button class="btn-pdf" id="zoomOutButton" class="zoomButton">Zoom Out</button>
                    <button class="btn-pdf" id="prevButton">Previous</button>
                    <div><span id="currentPageDisplay"></span></div>
                    <button class="btn-pdf" id="nextButton">Next</button>
                    <button class="btn-pdf" id="zoomInButton" class="zoomButton">Zoom In</button>
                    <a id="downloadButton" href="assets/pdf/881.pdf" download>Download PDF</a>
                </div>
                <canvas id="pdfRenderer" style="width: 100%;"></canvas>
            </div>
        </div>
    </div>
